...
:: Android packaging
set AND_CERT_NAME="MailYou"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MailYou.p12
...
set IOS_PROVISION=cert\MailYou.mobileprovision
...
set APP_ID=air.org.phpz.app.MailYou

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MailYou

:: Debugging using a custom IP
set DEBUG_IP=172.16.1.76
